...
<body>
						...
						<ul class="navbar-nav mr-auto" style="font-size: 20px">
							...
							<li class="nav-item dropdown mx-2"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nyelv</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="aboutus.jsp">Angol</a> <a class="dropdown-item" href="aboutushun.jsp">Magyar</a>
								</div></li>
						</ul>
					</div>
				</nav>
	...
	<div class="container w-50" style="position: relative; top: 130px;">
		<div class="shadow-lg p-2 mb-3 bg-black rounded">
			...
			<p>Kőfelületek esetében 1-5 fázisban történő csiszolást, majd polírozást végzünk. Ez függ a márvány, a mészkő vagy a terrazzo felületek igénybevételétől illetve, hogy lakáson belül vagy
				kültéren helyezkedik-e el a tisztítandó felület.</p>
			<p>Több éves tapasztalattal rendelkezünk a márvány felületek tisztításában, valamint szőnyeg és kárpittisztításában is. Felmérést követően rövid határidőn belül orvosolni tudjuk a sérült, matt,
				karcos vagy éppen vegyszerrel megmaratott kőfelületeit, hogy ismét régi fényükben ragyogjanak!</p>
			<p>Közös összefogással alapítottuk meg márványtisztító, karbantartó vállalkozásunkat. Kizárólag professzionális gépekkel dolgozunk. Magas szakmai tapasztalattal rendelkezünk. Elsődleges
				számunkra, hogy mindig kifogástalan munkát végezzünk megrendelőink felé.</p>
			<p>Büszkék vagyunk referenciáinkra, amikkel már bizonyítottuk, hogy precíz és megbízható szakemberek vagyunk! Vállalkozásunkat és gépeinket folyamatosan fejlesztjük, hogy minden téren
				kiszolgáljuk ügyfeleinket.</p>
