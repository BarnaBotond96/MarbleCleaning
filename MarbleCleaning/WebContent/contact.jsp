...
<body>
						...
						<ul class="navbar-nav mr-auto" style="font-size: 20px">
							...
							<li class="nav-item dropdown mx-2"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Language</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="contact.jsp">English</a> 
									<a class="dropdown-item" href="contacthun.jsp">Hungarian</a>
								</div>
						   </li>
						</ul>
					</div>
	...
	<div class="container w-50" style="position: relative; top: 130px;">
		<div class="shadow-lg p-2 mb-3 bg-black rounded">
			<p>• Mészáros László: +36-20-489-49-39</p>
			<p>• Horváth Gábor: +36-20-499-10-10</p>
			<p>• info@marvanytisztitas.hu</p>
			<p>• www.marvanytisztitas.hu</p>
