...
<body>
						...
						<ul class="navbar-nav mr-auto" style="font-size: 20px">
							...
							<li class="nav-item dropdown mx-2"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Language</a>
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="aboutus.jsp">English</a> <a class="dropdown-item" href="aboutushun.jsp">Hungarian</a>
								</div></li>
						</ul>
					</div>
				</nav>
	...
	<div class="container w-50" style="position: relative; top: 130px;">
		<div class="shadow-lg p-2 mb-3 bg-black rounded">
			...
			<p>In case of stone surface the activities above mean refining the surface in 1-5 phases and then polishing it. In case of all kinds of marble, limestone or terrazzo the work depends on the
				usage as well as on the fact where the surface to be cleaned is located – inside or outside the flat or house.</p>
			<p>Based on our more years of experience in cleaning marble surfaces as well as carpet and tapestry, after an assessment of the job we can quickly restore the damaged, matte, scratched or
				chemically etched stone surfaces. Our company possesses professional machinery since it is important for us that we could provide impeccable work for all of our customers.</p>
			<p>This is why we have founded our marble cleaning and maintaining company with joint collaboration.</p>
			<p>We are proud of our references as we have already proved at those corporations that we are precise and reliable people who provide high expertise and work with professional tools. Our
				company is continuously being developed in order to be able to serve our clients in all fields.</p>
